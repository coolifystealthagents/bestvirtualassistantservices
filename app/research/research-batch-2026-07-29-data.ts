...
function makePost(topic: typeof topics[number], index: number) {
  ...
  return {
    slug, primaryKeyword: `${role} virtual assistant philippines`, noScope: true,
    title,
