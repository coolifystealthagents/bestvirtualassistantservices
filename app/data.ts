...
export const blogPosts: BlogPost[] = [
  {
    ...
    minutes: 7,
    keyTakeaways: ['Give every provider the same task list.', 'Separate labor from management, tools, and training time.', 'Use a short initial agreement while you learn the workload.'],
    sections: [
    ...
    faq: [
      { q: 'Is a monthly plan better than hourly billing?', a: 'Monthly plans can work when the task list is steady. Hourly billing is easier to adjust while you are still learning the real workload.' },
  ...
  },
  {
    ...
    minutes: 6,
    keyTakeaways: ['Start with work that repeats and has a clear example.', 'Keep pricing, refunds, legal advice, and account approvals with the owner.', 'Review the first tasks at the same time each day.'],
    sections: [
      ...
      { heading: 'Keep the first test small', body: 'Pick a short set of recurring tasks for the first week. Give examples, show the tool, record one short walkthrough, and review the work at the same time each day.' },
    ],
    faq: [
      { q: 'How many tasks should I delegate at first?', a: 'Start with a short list that you can review closely. Adding too much at once can hide mistakes and make training messy.' },
  ...
  },
  {
    ...
    title: 'VA or employee: which one fits?',
    excerpt: 'When to hire in-house and when a managed assistant is the safer first step.',
    minutes: 8,
    keyTakeaways: ['A VA fits remote work that is easy to explain and check.', 'An employee fits work that needs in-person context or company authority.', 'Mark owner-only decisions before you compare either option.'],
    sections: [
    ...
    faq: [
      ...
      { q: 'Is a VA cheaper than an employee?', a: 'Often, but price is not the only issue. Training, quality checks, backup, and security matter too.' },
    ],
    sources: guideSources,
  },
  {
    ...
    minutes: 9,
    keyTakeaways: ['Prepare examples and access rules before day one.', 'Ask the assistant to explain the task back in their own words.', 'Fix confusing steps before you add more work.'],
    sections: [
    ...
    faq: [
      { q: 'How long does onboarding take?', a: 'It depends on the role and the quality of your examples. A narrow admin handoff is usually easier to teach than customer calls, bookkeeping support, or work spread across several tools.' },
