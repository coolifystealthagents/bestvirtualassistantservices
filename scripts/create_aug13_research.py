...
topics = [
('client-portal-administration','Client Portal Administration by Virtual Assistants','Client portal administration','virtual-assistant-client-portal-administration.webp','access requests, status changes, document visibility, and owner handoffs','portal permissions should match a documented business need, not a title or assumption','virtual-assistant-document-access-governance','virtual-assistant-client-onboarding-controls'),
('knowledge-base-research','Knowledge Base Research by Virtual Assistants','knowledge base research','virtual-assistant-knowledge-base-maintenance.webp','article gaps, duplicate answers, stale references, and unresolved questions','a researcher can locate and label evidence, while a subject owner approves policy or advice','virtual-assistant-knowledge-base-search-quality','virtual-assistant-research-briefs'),
('appointment-preparation','Appointment Preparation Support by Virtual Assistants','appointment preparation','virtual-assistant-calendar-booking-integrity.webp','intake details, confirmation status, accessibility needs, and missing information','preparation support must not become diagnosis, legal advice, or a promise about an appointment','virtual-assistant-appointment-setting-quality','virtual-assistant-calendar-delegation'),
('membership-administration','Membership Administration by Virtual Assistants','membership administration','virtual-assistant-customer-success-handoffs.webp','renewal records, member questions, consent status, and escalation notes','membership records need a clear distinction between administrative updates and eligibility decisions','virtual-assistant-customer-success-handoffs','virtual-assistant-customer-feedback-controls'),
('webinar-coordination','Webinar Coordination by Virtual Assistants','webinar coordination','virtual-assistant-event-operations.webp','registration records, speaker materials, attendance notes, and follow-up ownership','coordination can prepare records and reminders, but cannot grant rights or publish unapproved claims','virtual-assistant-event-operations','virtual-assistant-meeting-agenda-operations'),
('compliance-document-collection','Compliance Document Collection by Virtual Assistants','compliance document collection','virtual-assistant-document-retention-workflow.webp','requested records, received dates, version labels, gaps, and reviewer questions','collection is administrative evidence handling, not a certification that a business complies','virtual-assistant-document-retention-workflow','virtual-assistant-vendor-risk-review'),
('review-response-triage','Review and Response Triage by Virtual Assistants','review and response triage','virtual-assistant-customer-feedback-controls.webp','incoming reviews, response categories, draft status, sentiment flags, and owner escalation','triage may classify and route feedback, but sensitive disputes and final public replies need an owner','virtual-assistant-client-feedback-analysis','virtual-assistant-social-media-moderation'),
('business-continuity-support','Business Continuity Support by Virtual Assistants','business continuity support','virtual-assistant-remote-work-continuity.webp','critical task lists, contact paths, alternate records, and recovery status','continuity planning should identify dependencies and owners without claiming a system is resilient','virtual-assistant-backup-coverage-controls','virtual-assistant-remote-onboarding-controls'),
('localization-quality','Localization Quality Support by Virtual Assistants','localization quality','virtual-assistant-accessibility-review-controls.webp','language variants, terminology records, formatting checks, and reviewer questions','language support can identify inconsistencies, but a qualified owner approves high-impact meaning','virtual-assistant-digital-accessibility-review','virtual-assistant-website-update-accessibility'),
('supplier-research','Supplier Research by Virtual Assistants','supplier research','virtual-assistant-vendor-research-due-diligence.webp','public company records, stated capabilities, document dates, and comparison notes','research can organize public evidence, but cannot approve a supplier or verify a claim without support','virtual-assistant-vendor-research-due-diligence','virtual-assistant-procurement-coordination'),
]
...
---
'''
    (OUT / f'{slug}.mdx').write_text(fm + body((slug,title,role,image,scope,boundary,rel1,rel2)), encoding='utf-8')
