---
slug: virtual-assistant-knowledge-base-broken-path-patrol
title: Run a Broken-Path Patrol for a Virtual Assistant Knowledge Base
excerpt: A broken-path patrol finds dead links and stranded instructions while preserving content ownership and review boundaries.
...
heroImageAlt: Run a Broken-Path Patrol for a Virtual Assistant Knowledge Base
...
## Start with the record behind knowledge paths
