---
slug: virtual-assistant-part-time-vs-full-time-planning
title: Part-Time vs Full-Time Virtual Assistant: A Workload Test
excerpt: A practical guide to capacity planning using observable workload, clear authority, and review evidence.
publishedAt: 2026-09-18
updatedAt: 2026-09-18
category: Hiring
tags: [virtual assistant, capacity planning, delegation]
featuredImage: /blog/images/virtual-assistant-capacity-planning.webp
heroImageAlt: Part-Time vs Full-Time Virtual Assistant: A Workload Test
...
---
# Part-Time vs Full-Time Virtual Assistant: A Workload Test

Choosing a virtual assistant is easier when the work is described as an operating system rather than a list of attractive traits. This guide turns capacity choice into a decision a manager can inspect. It uses a realistic example, a founder with 18 hours of recurring work and irregular launches, and keeps preparation separate from the judgments that still belong to the business owner.

## Part-Time vs Full-Time Virtual Assistant: A Workload Test: begin with the business outcome

Write one sentence describing what should be reliably different after the role is working. Then record weekly volume, peaks, response windows, meeting load, and management time. These details reveal whether the request is repeatable support, a specialist project, or a collection of unrelated jobs. They also prevent a candidate from being judged against expectations that were never shared.
...
Use five to ten samples that reflect ordinary work, incomplete inputs, duplicates, urgent cases, and an out-of-scope request. For a founder with 18 hours of recurring work and irregular launches, include at least one record where two instructions conflict. Provide the same source material, access limits, deadline, and output format that would exist in the real role. Do not create a trick test whose difficulty comes from missing instructions.
