---
slug: virtual-executive-assistant-meeting-brief
title: What to Put in an Executive Meeting Brief
excerpt: A practical guide to meeting preparation using observable workload, clear authority, and review evidence.
publishedAt: 2026-09-18
updatedAt: 2026-09-18
category: Executive Assistance
tags: [virtual assistant, meeting preparation, delegation]
featuredImage: /blog/images/virtual-assistant-meeting-preparation-process.webp
heroImageAlt: What to Put in an Executive Meeting Brief
...
---
# What to Put in an Executive Meeting Brief

Choosing a virtual assistant is easier when the work is described as an operating system rather than a list of attractive traits. This guide turns meeting brief into a decision a manager can inspect. It uses a realistic example, an executive joining a renewal call after several months away, and keeps preparation separate from the judgments that still belong to the business owner.

## What to Put in an Executive Meeting Brief: begin with the business outcome

Write one sentence describing what should be reliably different after the role is working. Then record purpose, attendees, history, decisions, risks, agenda, and follow-up. These details reveal whether the request is repeatable support, a specialist project, or a collection of unrelated jobs. They also prevent a candidate from being judged against expectations that were never shared.
...
Use five to ten samples that reflect ordinary work, incomplete inputs, duplicates, urgent cases, and an out-of-scope request. For an executive joining a renewal call after several months away, include at least one record where two instructions conflict. Provide the same source material, access limits, deadline, and output format that would exist in the real role. Do not create a trick test whose difficulty comes from missing instructions.
