---
slug: virtual-assistant-performance-review-cadence
title: Virtual Assistant Performance Reviews: A Practical Cadence and Scorecard
excerpt: A practical guide to how often to review service performance and which evidence separates individual execution issues from process, source, or management defects, with a realistic work sample, decision boundaries, measures, and provider questions.
...
---
# Virtual Assistant Performance Reviews: A Practical Cadence and Scorecard

Buying virtual assistant services should begin with an operating decision, not a list of attractive tasks. The real question is how often to review service performance and which evidence separates individual execution issues from process, source, or management defects. A useful answer identifies the work, the evidence an assistant may rely on, the decisions that stay with the business, and the result that a reviewer will inspect.

Consider a business owner reviewing an assistant who handles 450 monthly administrative items across four workflows. This example is illustrative rather than a claim about a typical company. Replace its volumes and constraints with your own records. The method is to make assumptions visible before comparing a provider, granting access, or promising a service window.

## Virtual Assistant Performance Reviews: start with the outcome and baseline
...
For this role, use the following boundary: The review may assess work against written expectations; business owners retain employment or contract decisions, policy changes, compensation, and acceptance of risk. Adapt it to your agreements, industry duties, and systems. A provider should be able to explain how that boundary appears in instructions, training, account permissions, quality review, and escalation, not just repeat it on a sales call.
...
A work sample should resemble the role without exposing live customer data or creating a free production assignment. One suitable test is a monthly review pack containing a balanced sample, three exceptions, one late owner approval, one changed instruction, and trend data. Give every provider or candidate the same materials, deadline, tools, and output format. Explain what may be assumed and what requires a question.
...
Use these questions as a core: Which outcomes matter? What sample is reviewed? How are instruction defects separated? Who owns each corrective action and deadline? Follow each answer with “show me how that works.” Useful evidence might be a redacted checklist, a sample escalation, a permission map, a quality rubric, or a walkthrough by the person who will supervise the work.
...
Track first-pass acceptance, severe defects, on-time completion by eligible item, escalation quality, and improvement actions closed. Define every measure before the pilot. “Accuracy” is meaningless until the reviewed population, defect classes, and acceptance rule are clear. Keep the denominator with every rate and report volume beside response time. Ten fast responses during a quiet week do not prove peak coverage.
