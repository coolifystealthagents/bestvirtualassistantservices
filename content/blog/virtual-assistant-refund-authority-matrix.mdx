---
slug: virtual-assistant-refund-authority-matrix
title: Build a Refund Authority Matrix for Customer Support
excerpt: A practical guide to refund support using observable workload, clear authority, and review evidence.
publishedAt: 2026-09-18
updatedAt: 2026-09-18
category: Customer Support
tags: [virtual assistant, refund support, delegation]
featuredImage: /blog/images/virtual-assistant-customer-refund-escalation.webp
heroImageAlt: Build a Refund Authority Matrix for Customer Support
...
---
# Build a Refund Authority Matrix for Customer Support

Choosing a virtual assistant is easier when the work is described as an operating system rather than a list of attractive traits. This guide turns refund decision into a decision a manager can inspect. It uses a realistic example, a late shipment with a partial-use claim and a repeat customer, and keeps preparation separate from the judgments that still belong to the business owner.

## Build a Refund Authority Matrix for Customer Support: begin with the business outcome

Write one sentence describing what should be reliably different after the role is working. Then record request type, evidence, threshold, approver, response, record, and escalation. These details reveal whether the request is repeatable support, a specialist project, or a collection of unrelated jobs. They also prevent a candidate from being judged against expectations that were never shared.
...
Use five to ten samples that reflect ordinary work, incomplete inputs, duplicates, urgent cases, and an out-of-scope request. For a late shipment with a partial-use claim and a repeat customer, include at least one record where two instructions conflict. Provide the same source material, access limits, deadline, and output format that would exist in the real role. Do not create a trick test whose difficulty comes from missing instructions.
