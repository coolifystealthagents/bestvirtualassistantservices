---
slug: virtual-assistant-capacity-planning-calculator
title: Virtual Assistant Capacity Planning: Estimate Hours Before You Buy
excerpt: A practical guide to how much usable assistant capacity a defined workload needs after accounting for variation, review, meetings, rework, and coverage, with a realistic work sample, decision boundaries, measures, and provider questions.
...
---
# Virtual Assistant Capacity Planning: Estimate Hours Before You Buy

Buying virtual assistant services should begin with an operating decision, not a list of attractive tasks. The real question is how much usable assistant capacity a defined workload needs after accounting for variation, review, meetings, rework, and coverage. A useful answer identifies the work, the evidence an assistant may rely on, the decisions that stay with the business, and the result that a reviewer will inspect.

Consider a founder estimating support for 250 inbox threads, 90 calendar requests, 400 CRM updates, and four reports each month. This example is illustrative rather than a claim about a typical company. Replace its volumes and constraints with your own records. The method is to make assumptions visible before comparing a provider, granting access, or promising a service window.

## Virtual Assistant Capacity Planning: start with the outcome and baseline
...
For this role, use the following boundary: The estimate can support staffing choices but does not guarantee output; owners retain budgets, priorities, workload acceptance, and changes to customer commitments. Adapt it to your agreements, industry duties, and systems. A provider should be able to explain how that boundary appears in instructions, training, account permissions, quality review, and escalation, not just repeat it on a sales call.
...
A work sample should resemble the role without exposing live customer data or creating a free production assignment. One suitable test is a low, expected, and peak month calculated from observed ranges rather than one optimistic average. Give every provider or candidate the same materials, deadline, tools, and output format. Explain what may be assumed and what requires a question.
...
Use these questions as a core: Which work drives the peak? What time is truly productive? How much review remains internal? What happens when demand exceeds the plan? Follow each answer with “show me how that works.” Useful evidence might be a redacted checklist, a sample escalation, a permission map, a quality rubric, or a walkthrough by the person who will supervise the work.
