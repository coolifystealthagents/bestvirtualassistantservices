---
slug: virtual-assistant-trial-project-scorecard
title: How to Score a Virtual Assistant Trial Project
excerpt: A practical guide to work sample review using observable workload, clear authority, and review evidence.
publishedAt: 2026-09-18
updatedAt: 2026-09-18
category: Hiring
tags: [virtual assistant, work sample review, delegation]
featuredImage: /blog/images/virtual-assistant-work-sample-review.webp
heroImageAlt: How to Score a Virtual Assistant Trial Project
...
---
# How to Score a Virtual Assistant Trial Project

Choosing a virtual assistant is easier when the work is described as an operating system rather than a list of attractive traits. This guide turns trial project into a decision a manager can inspect. It uses a realistic example, a five-day inbox classification exercise, and keeps preparation separate from the judgments that still belong to the business owner.

## How to Score a Virtual Assistant Trial Project: begin with the business outcome

Write one sentence describing what should be reliably different after the role is working. Then record accuracy, judgment, documentation, questions, and handoff quality. These details reveal whether the request is repeatable support, a specialist project, or a collection of unrelated jobs. They also prevent a candidate from being judged against expectations that were never shared.
...
Use five to ten samples that reflect ordinary work, incomplete inputs, duplicates, urgent cases, and an out-of-scope request. For a five-day inbox classification exercise, include at least one record where two instructions conflict. Provide the same source material, access limits, deadline, and output format that would exist in the real role. Do not create a trick test whose difficulty comes from missing instructions.
