---
slug: virtual-assistant-client-meeting-brief
title: Preparing a Client Meeting Brief
excerpt: Practical guidance for organizing client meeting brief with clear records, review points, and sensible boundaries.
...
heroImageAlt: Preparing a Client Meeting Brief
...
---
# Preparing a Client Meeting Brief

A client meeting brief should help people arrive prepared with verified context, clear questions, and a realistic decision list.

## Preparing a Client Meeting Brief starts with a reliable record

Gather the last approved summary, open actions, requested decisions, relevant links, and attendee roles. Note the date each source was checked. Name the source of truth before work begins, record when it was checked, and make the intended outcome explicit. This keeps a small administrative task from becoming a chain of assumptions.

## Separate preparation from approval

Keep recommendations and commitments with the meeting owner. The assistant can identify missing context and organize the brief without presenting an unapproved position. A virtual assistant can gather details, normalize labels, identify missing fields, and prepare a review queue. The owner or designated specialist should retain decisions that affect commitments, sensitive information, public statements, or irreversible changes.
